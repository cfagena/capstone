...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(msg.sender != address(0), 'Caller address must be real');
...
//  2) create a public setter using the inherited onlyOwner modifier 
    function setPause(bool value) public 
    onlyOwner {
        _paused = value;
        if (_paused) {
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender != to, "Do not need to give permission for themself");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner() || isApprovedForAll(msg.sender, to), "Sender is not the contract owner and operator isApprovedForAll is not true");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from, "Token does not belong to from address");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "Address to is invalid");
...
contract CustomERC721Token is ERC721Metadata("MINHOCOINS", "MNC", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
